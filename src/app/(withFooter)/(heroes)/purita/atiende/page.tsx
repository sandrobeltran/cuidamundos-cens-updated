...
const pages1: TBookPage[] = [
  ...
  {
    bg: "/img/purita/attends/calido.jpg",
  },
  {
  ...
  {
    bg: "/img/purita/attends/invernadero.jpg",
  },
  {
  ...
  {
    bg: "/img/purita/attends/migracion.jpg",
  },
];

const pages2: TBookPage[] = [
  {
    bg: "/img/purita/attends/templado.jpg",
  },
  {
  ...
  {
    bg: "/img/purita/attends/calentamiento.jpg",
  },
  {
  ...
  {
    bg: "/img/purita/attends/glaciares.jpg",
  },
  {
...
const pages3: TBookPage[] = [
  ...
  {
    bg: "/img/purita/attends/frio.jpg",
  },
  {
  ...
  {
    bg: "/img/purita/attends/arrecifes.jpg",
  },
  {
  ...
  {
    bg: "/img/purita/attends/abandono.jpg",
  },
];
