          ...
          <div className="mt-6 grid w-full grid-cols-3 justify-between gap-10 px-12">
            ...
            <Link href={"/purita"}>
              <div className="flex cursor-pointer flex-col gap-2 transition-transform hover:-translate-y-10 hover:scale-110">
                ...
                <div className="flex flex-col items-center gap-2 rounded-bl-3xl rounded-br-3xl bg-purita px-5 pb-7 pt-3 text-center text-white shadow-xl shadow-stone-950/20">
            ...
            <Link href={"/jirol"}>
              <div className="flex cursor-pointer flex-col gap-2 transition-transform hover:-translate-y-10 hover:scale-110">
                ...
                <div className="flex flex-col items-center gap-2 rounded-bl-3xl rounded-br-3xl bg-jirol px-5 pb-7 pt-3 text-center text-white shadow-xl shadow-stone-950/20">
            ...
            <Link href={"/felix"}>
              <div className="flex cursor-pointer flex-col gap-2 transition-transform hover:-translate-y-10 hover:scale-110">
                ...
                <div className="flex flex-col items-center gap-2 rounded-bl-3xl rounded-br-3xl bg-felix px-5 pb-7 pt-3 text-center text-white shadow-xl shadow-stone-950/20">
