...
const GamesHero = ({ title, description }: TProps) => {
  return (
    <section
      ...
      className="relative col-span-12 flex h-fit items-start justify-start px-24 py-28 text-sm text-stone-700 max-sm:h-fit max-sm:flex-col max-sm:bg-[cover] max-sm:px-4 max-sm:py-0 max-sm:pt-36
      "
    >
      <SkyBackground />
